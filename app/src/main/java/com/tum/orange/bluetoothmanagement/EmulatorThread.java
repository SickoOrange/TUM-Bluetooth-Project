    ...
    public void run() {
        ...
        while (true) {
            ...
            if (!isFinished) {
                ...
                float Emulator_Data_FloatValue = decimal.setScale(2, BigDecimal.ROUND_HALF_UP).floatValue();
                System.out.println(Emulator_Data);
                try {
                    Thread.currentThread().sleep(1000);
                    handler.obtainMessage(Constant.MESSAGE_READ, String.valueOf(Emulator_Data_FloatValue)).sendToTarget();
